            ...
            if product == "STARFRUIT":
             ...
             ### BUY ###
                ...
                if new_position > 17 and rem_buy > 0:
                    ...
                    rem_buy -= size
                    assert(size >= 0)
                    product_orders.append(Order(product, min(best_buy_pr + 3, acceptable_price - 2), size))
                ...
                if new_position < -17 and rem_sell > 0:
                    ...
                    rem_sell -= size
                    assert(size >= 0)
                    product_orders.append(Order(product, max(best_sell_pr - 3, acceptable_price + 2), -size))
