            ...
            if product == "STARFRUIT":
             ...
             ### BUY ###
                ...
                if new_position < -17 and rem_buy > 0:
                    size = min(rem_buy, max_size, -new_position-17)
                    rem_buy -= size
                    assert(size >= 0)
                    product_orders.append(Order(product, min(best_buy_pr + 1, acceptable_price), size))   
             
                if new_position >= -17 and new_position < 0 and rem_buy > 0:
                ...
                if new_position > 15 and rem_buy > 0:
                    ...
                    rem_buy -= size
                    assert(size >= 0)
                    product_orders.append(Order(product, min(best_buy_pr, acceptable_price - 2), size))
                ...
                if new_position > 17 and rem_sell > 0:
                    size = min(rem_sell, max_size, new_position-17)
                    rem_sell -= size
                    assert(size >= 0)
                    product_orders.append(Order(product, max(best_sell_pr - 1, acceptable_price), size))   
                
                
                if new_position <= 17 and new_position > 0 and rem_sell > 0:
                ...
                if new_position < -15 and rem_sell > 0:
                    ...
                    rem_sell -= size
                    assert(size >= 0)
                    product_orders.append(Order(product, max(best_sell_pr, acceptable_price + 2), -size))
            ...
            if product == "AMETHYSTS":
             ...
             ### BUY ###
                ...
                if new_position > 17 and rem_sell > 0:
                    ...
                    rem_sell -= size
                    assert(size >= 0)
                    product_orders.append(Order(product, min(best_sell_pr - 1, acceptable_price), size))             
