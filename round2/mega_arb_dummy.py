    ...
    def run(self, state: TradingState) -> tuple[dict[Symbol, list[Order]], int, str]:
        ...
        for product in ["ORCHIDS"]:
            ...
            if(true_south_ask < best_local_ask):
                product_orders.append(Order(product, min(round(true_south_ask) + 2, best_local_ask) , -rem_sell))
                print("Sell order details:", "Product:", product, "Price:", min(round(true_south_ask) + 2, best_local_ask), "Amount:", -rem_sell)
